...
import com.baibei.accountservice.filter.DynamicDataSourceFilter;
...
public class Bootstrap extends WebMvcConfigurerAdapter implements SchedulingConfigurer{
    ...
    public FilterRegistrationBean  filterRegistrationBean() {  
        ...
        DynamicDataSourceFilter dynamicDataSourceFilter = new DynamicDataSourceFilter();
        registrationBean.setFilter(dynamicDataSourceFilter);  
